...
```{r}
# Assuming 'model' is your fitted GLM
pseudo_r2 <- pR2(model_opt)

pseudo_r2
```

Confrontando i valori dell'adjusted R\^2 vediamo che l'aggiunta di una covariata data dal termine di interazioni, fa aumentare l'indice di un millesimo. Dunque non risulta vantaggioso il tradeoff e manteniamo il modello precedente.
